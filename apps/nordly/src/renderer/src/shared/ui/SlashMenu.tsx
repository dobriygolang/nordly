...
function slashCommands(t: TFunc): SlashCommand[] {
  return [
    {
      id: 'h1',
      label: t('nordly.slash.h1.label'),
      description: t('nordly.slash.h1.desc'),
      action: (e) => e.insertBlock('# '),
    },
    {
      id: 'h2',
      label: t('nordly.slash.h2.label'),
      description: t('nordly.slash.h2.desc'),
      action: (e) => e.insertBlock('## '),
    },
    {
      id: 'h3',
      label: t('nordly.slash.h3.label'),
      description: t('nordly.slash.h3.desc'),
      action: (e) => e.insertBlock('### '),
    },
    {
      id: 'code',
      label: t('nordly.slash.code.label'),
      description: t('nordly.slash.code.desc'),
      shortcut: '```',
      action: (e) => e.insertCodeBlock(),
    },
    {
      id: 'bullet',
      label: t('nordly.slash.bullet.label'),
      description: t('nordly.slash.bullet.desc'),
      shortcut: '-',
      action: (e) => e.insertBlock('- '),
    },
    {
      id: 'todo',
      label: t('nordly.slash.todo.label'),
      description: t('nordly.slash.todo.desc'),
      shortcut: '[]',
      action: (e) => e.insertBlock('- [ ] '),
    },
    {
      id: 'divider',
      label: t('nordly.slash.divider.label'),
      description: t('nordly.slash.divider.desc'),
      shortcut: '---',
      action: (e) => e.insertBlock('---\n'),
    },
    {
      id: 'quote',
      label: t('nordly.slash.quote.label'),
      description: t('nordly.slash.quote.desc'),
      shortcut: '>',
      action: (e) => e.insertBlock('> '),
    },
  ];
...
export function SlashMenu({ x, y, query, editor, onClose, onBeforeAction }: SlashMenuProps) {
  ...
  return createPortal(
    <div
      ...
      className="nordly-floating-menu"
