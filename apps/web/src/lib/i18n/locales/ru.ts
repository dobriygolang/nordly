...
export const ru = {
  ...
  seo: {
    ...
    ogImageAlt: 'Превью workspace Nordly',
  ...
  pricing: {
    ...
    subtitle: 'Чем Free отличается от Pro в desktop-приложении Nordly.',
    limitColumn: 'Лимит',
  ...
  welcome: {
    ...
    demoAriaLabel: 'Превью workspace Nordly',
