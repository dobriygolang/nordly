...
#     git@github.com:YOUR_ORG/project-nordly.git
#
# Or:
#   ./scripts/bootstrap-server.sh git@github.com:YOUR_ORG/project-nordly.git
set -euo pipefail

REPO_DIR="${REPO_DIR:-/opt/project-nordly}"
GIT_URL="${1:-}"
BRANCH="${BRANCH:-main}"

if [ -z "$GIT_URL" ]; then
  echo "Usage: $0 <git-clone-url>"
  echo "Example: $0 git@github.com:your-org/project-nordly.git"
  exit 1
fi
